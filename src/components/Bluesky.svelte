<a class="text-gray-900 transition hover:text-logo-red dark:text-yellow-400 dark:hover:text-logo-red" href="https://bsky.app/profile/theosteiner.de">
  <span>Bluesky</span>
  <svg id="flutterby" viewBox="0 0 566 500" xmlns="http://www.w3.org/2000/svg">
    <defs>
